...
/*
 * MeshCore-specific SX1278 driver.
 *
 * MeshCore currently ships CustomSX1276, but RadioLib treats SX1278 as
 * the base implementation for the SX1276/77/79 family.  This variant
 * uses the actual SX1278 class so the 433 MHz parameter range is handled
 * by RadioLib directly.
 */
class CustomSX1278 : public SX1278 {
public:
    explicit CustomSX1278(Module* mod) : SX1278(mod) {}
